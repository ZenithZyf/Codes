...
%     load 'F:\Projects\SFDI\MuspI.mat'
    load 'E:\Projects\SFDI\fsolveTable.mat'
...
%         end
        ...
        Mua_savename  = fullfile(folder_name,category_case(i),'Muadc.mat');
        Musp_savename = fullfile(folder_name,category_case(i),'Muspdc.mat');
