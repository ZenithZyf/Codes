name = 'E:\Yifeng Zeng\!PhD Work\Projects\OCT\Ovary-Data-Processing\! Final-Processing\~Scattering-Map\usCropped';
listing = dir(name);
sizeListing = size(listing,1);
fpath = 'E:\Yifeng Zeng\!PhD Work\Projects\OCT\Ovary-Data-Processing\! Final-Processing\~Scattering-Map\histogram_Gaussian_fitting';
...
for i = 3:sizeListing
    ...
    % if cancer, save to columns that mod 3 get 1
    if matchStr{3} == 'c'
        saveCol = 3*patientNum-2;
        diagnose = 'Cancer';
    % if benign, save to columns that mod 3 get 2
    elseif matchStr{3} == 'b'
        saveCol = 3*patientNum-1;
        diagnose = 'Benign';
    % if tube, save to columns that mod 3 get 0
    elseif matchStr{3} == 't'
        saveCol = 3*patientNum;
        diagnose = 'Tube';
    end
